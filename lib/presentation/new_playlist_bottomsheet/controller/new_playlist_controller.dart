...
import 'package:music_app/presentation/new_playlist_bottomsheet/models/new_playlist_model.dart';
...
class NewPlaylistController extends GetxController {
  ...
  onSelected(dynamic value) {
    ...
    newPlaylistModelObj.value.dropdownItemList.forEach((element) {
