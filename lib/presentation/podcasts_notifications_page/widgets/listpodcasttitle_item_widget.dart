...
class ListpodcasttitleItemWidget extends StatelessWidget {
  ListpodcasttitleItemWidget(this.listpodcasttitleItemModelObj);

  ListpodcasttitleItemModel listpodcasttitleItemModelObj;
          ...
          child: Column(
            ...
            children: [
              Container(
                ...
                child: Obx(
                  () => Text(
                    listpodcasttitleItemModelObj.podcastTitleTxt.value,
                    maxLines: null,
                ...
                child: Row(
                  children: [
                    Padding(
                      ...
                      child: Obx(
                        () => Text(
                          listpodcasttitleItemModelObj.authorTxt.value,
                    ...
                    Padding(
                      ...
                      child: Obx(
                        () => Text(
                          listpodcasttitleItemModelObj.timeTxt.value,
                          overflow: TextOverflow.ellipsis,
                          textAlign: TextAlign.left,
                          style: AppStyle.txtUrbanistRomanMedium12.copyWith(
                            letterSpacing: getHorizontalSize(
