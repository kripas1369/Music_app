...
class Listpodcasttitle1ItemWidget extends StatelessWidget {
  Listpodcasttitle1ItemWidget(this.listpodcasttitle1ItemModelObj);

  Listpodcasttitle1ItemModel listpodcasttitle1ItemModelObj;
          ...
          child: Column(
            ...
            children: [
              Container(
                ...
                child: Obx(
                  () => Text(
                    listpodcasttitle1ItemModelObj.podcastTitleTxt.value,
                    maxLines: null,
                    textAlign: TextAlign.left,
                    style: AppStyle.txtUrbanistRomanBold18Gray9001,
                  ),
                ),
              ),
              Padding(
                ...
                child: Row(
                  children: [
                    Padding(
                      ...
                      child: Obx(
                        () => Text(
                          listpodcasttitle1ItemModelObj.companyTxt.value,
                    ...
                    Padding(
                      ...
                      child: Obx(
                        () => Text(
                          listpodcasttitle1ItemModelObj.timeTxt.value,
                          overflow: TextOverflow.ellipsis,
                          textAlign: TextAlign.left,
                          style: AppStyle.txtUrbanistRomanMedium12.copyWith(
                            letterSpacing: getHorizontalSize(
